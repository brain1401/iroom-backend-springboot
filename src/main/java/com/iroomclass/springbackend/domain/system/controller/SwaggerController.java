 ...
 * 
 * <p>
 * OpenAPI 스펙 문서를 다양한 형식(JSON, YAML, YML)으로 다운로드할 수 있는 기능을 제공합니다.
 * </p>
 */
@RestController
...
public class SwaggerController {
     ...
     */
    @Operation(summary = "JSON 형식 OpenAPI 스펙 다운로드", description = """
            ...
            """)
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "JSON 파일 다운로드 성공", content = @Content(mediaType = "application/json", schema = @Schema(type = "object", description = "OpenAPI 3.x 스펙"))),
     ...
     */
    @Operation(summary = "YAML 형식 OpenAPI 스펙 다운로드", description = """
            ...
            """)
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "YAML 파일 다운로드 성공", content = @Content(mediaType = "application/x-yaml", schema = @Schema(type = "string", description = "OpenAPI 3.x 스펙 (YAML 형식)"))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류")
    })
     ...
     */
    @Operation(summary = "YML 형식 OpenAPI 스펙 다운로드", description = """
            ...
            """)
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "YML 파일 다운로드 성공", content = @Content(mediaType = "application/x-yaml", schema = @Schema(type = "string", description = "OpenAPI 3.x 스펙 (YML 형식)"))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류")
    })
