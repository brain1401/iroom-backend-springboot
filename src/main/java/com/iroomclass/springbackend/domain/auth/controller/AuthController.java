...
public class AuthController {
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "검증 완료 - 성공/실패 여부 반환", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponse.class), examples = {
                    @ExampleObject(name = "학생 검증 성공", summary = "DB에서 매칭되는 학생을 찾은 경우", value = """
                            {
                              "result": "SUCCESS",
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "잘못된 요청 - 필수 필드 누락 또는 형식 오류", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponse.class), examples = @ExampleObject(name = "입력 검증 오류", value = """
                    {
                      "result": "ERROR",
                      "message": "이름은 필수입니다",
                      "data": null
                    ...
                    """))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponse.class), examples = @ExampleObject(name = "서버 오류", value = """
                    {
                      "result": "ERROR",
    ...
    @Operation(summary = "선생님 검증", description = """
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "검증 완료 - 성공/실패 여부 반환", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponse.class), examples = {
                    @ExampleObject(name = "선생님 검증 성공", summary = "DB에서 매칭되는 선생님을 찾은 경우", value = """
                            {
                              "result": "SUCCESS",
                            ...
                            """),
                    @ExampleObject(name = "선생님 검증 실패", summary = "DB에서 매칭되는 선생님을 찾지 못한 경우", value = """
                            {
                              "result": "SUCCESS",
                              "message": "선생님 검증이 완료되었습니다",
                              "data": {
