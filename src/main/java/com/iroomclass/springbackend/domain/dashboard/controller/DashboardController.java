package com.iroomclass.springbackend.domain.dashboard.controller;

import com.iroomclass.springbackend.common.ApiResponse;
import com.iroomclass.springbackend.domain.dashboard.dto.DashboardDto;
import com.iroomclass.springbackend.domain.dashboard.service.DashboardService;
 ...
 */
@Slf4j
@Tag(name = "대시보드 API", description = "관리자 대시보드 API")
@RestController
