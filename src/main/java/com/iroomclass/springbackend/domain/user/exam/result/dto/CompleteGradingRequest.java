...
public record CompleteGradingRequest(
    ...
    @Schema(description = "시험 결과 ID", example = "123e4567-e89b-12d3-a456-426614174000", requiredMode = Schema.RequiredMode.REQUIRED)
    UUID resultId,
    
    @Size(max = 1000, message = "채점 코멘트는 1000자 이하여야 합니다")
    @Schema(description = "채점 코멘트", example = "전체적으로 잘 답변했습니다. 문제 3번의 설명이 조금 부족하지만 이해도는 충분합니다.")
    String comment
) {
