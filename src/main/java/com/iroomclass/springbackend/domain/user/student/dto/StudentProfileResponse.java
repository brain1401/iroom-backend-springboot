...
public record StudentProfileResponse(
    ...
    @Schema(description = "생년월일", example = "2008-03-15", requiredMode = Schema.RequiredMode.REQUIRED)
    LocalDate birthDate,
    
    @Schema(description = "학년", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    Integer grade
) {
    /**
