...
public class StudentService {
     ...
     * @return 문제별 결과 정보
     */
    public QuestionResultResponse getQuestionResult(UUID submissionId, UUID questionId, String studentName,
            String studentPhone) {
        ...
        // 2단계: 답안 조회
        StudentAnswerSheet answer = studentAnswerSheetRepository
                .findByExamSubmissionIdAndQuestionId(submissionId, questionId)
                .orElseThrow(() -> new IllegalArgumentException(
                        "존재하지 않는 답안입니다: 제출 ID=" + submissionId + ", 문제 ID=" + questionId));
