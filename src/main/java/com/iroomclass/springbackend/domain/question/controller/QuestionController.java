package com.iroomclass.springbackend.domain.question.controller;
...
import com.iroomclass.springbackend.domain.question.service.QuestionService;
...
public class QuestionController {
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "400", description = "잘못된 단원 ID"),
        @ApiResponse(responseCode = "404", description = "단원을 찾을 수 없음")
    })
    public ResponseEntity<QuestionListResponse> getQuestionsByUnit(
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "조회 성공"),
        @ApiResponse(responseCode = "400", description = "잘못된 단원 ID 또는 난이도"),
        @ApiResponse(responseCode = "404", description = "단원을 찾을 수 없음")
    })
    public ResponseEntity<QuestionListResponse> getQuestionsByUnitAndDifficulty(
            @Parameter(description = "단원 ID", example = "1") 
            @PathVariable Long unitId,
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "조회 성공"),
        @ApiResponse(responseCode = "400", description = "잘못된 문제 ID"),
    ...
    public ResponseEntity<QuestionStatisticsResponse> getQuestionStatisticsByUnit(
            @Parameter(description = "단원 ID", example = "1") 
            @PathVariable Long unitId) {
    ...
    public ResponseEntity<QuestionSearchResponse> searchQuestions(
