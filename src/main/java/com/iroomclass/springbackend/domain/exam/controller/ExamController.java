...
import com.iroomclass.springbackend.domain.exam.dto.ExamCreateRequest;
import com.iroomclass.springbackend.domain.exam.dto.ExamCreateResponse;
import com.iroomclass.springbackend.domain.exam.dto.ExamListResponse;
...
public class ExamController {
    ...
    @Operation(
        summary = "시험 등록",
        description = "시험지 초안을 기반으로 실제 시험을 등록합니다."
    )
    @ApiResponses({
    ...
    @Operation(
        summary = "전체 시험 목록 조회",
        description = "모든 학년의 시험 목록을 최신순으로 조회합니다."
    )
    @ApiResponses({
    ...
    @Operation(
        ...
        description = "특정 학년의 시험 목록을 조회합니다."
    )
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "조회 성공"),
        @ApiResponse(responseCode = "400", description = "잘못된 학년")
    })
    public ResponseEntity<ExamListResponse> getExamsByGrade(
    ...
    public ResponseEntity<ExamDetailResponse> updateExam(
            @Parameter(description = "시험 ID", example = "1") 
            @PathVariable Long examId,
