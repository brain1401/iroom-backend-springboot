...
public record ExamResultDto(
        @Schema(description = "시험 결과 ID", example = "123e4567-e89b-12d3-a456-426614174000") UUID id,

        @Schema(description = "시험 제출 ID", example = "123e4567-e89b-12d3-a456-426614174001") UUID submissionId,

        @Schema(description = "채점일시", example = "2025-08-17T14:30:00") LocalDateTime gradedAt,

        @Schema(description = "총점", example = "85") Integer totalScore,

        @Schema(description = "채점 상태", example = "COMPLETED") ResultStatus status,

        @Schema(description = "채점 코멘트", example = "전체적으로 잘 답변했습니다.") String gradingComment,

        @Schema(description = "재채점 버전", example = "1") Integer version,

        @Schema(description = "채점 진행률", example = "1.0") BigDecimal gradingProgress,

        @Schema(description = "AI 자동 채점 여부 (항상 true)", example = "true") Boolean isAutoGrading,

        @Schema(description = "채점 완료 여부", example = "true") Boolean isCompleted,

        @Schema(description = "재채점 여부", example = "false") Boolean isRegraded,

        @Schema(description = "문제별 채점 결과 목록") List<QuestionResultDto> questionResults,
