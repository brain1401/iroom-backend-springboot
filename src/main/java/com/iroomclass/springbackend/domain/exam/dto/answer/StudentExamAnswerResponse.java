...
public record StudentExamAnswerResponse(
        ...
        @Schema(description = "답안 이미지 URL (주관식 문제용)", example = "/uploads/answers/answer_1.jpg", nullable = true) String answerImageUrl,

        @Schema(description = "AI 인식 결과 (주관식 문제용)", example = "x = 5", nullable = true) String answerText,
     ...
     */
    public static StudentExamAnswerResponse from(StudentAnswerSheetQuestion problem, StudentAnswerSheet answerSheet) {
