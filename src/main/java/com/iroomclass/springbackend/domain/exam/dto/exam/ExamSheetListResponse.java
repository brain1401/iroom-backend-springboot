...
public record ExamSheetListResponse(
        @Schema(description = "학년 (전체 목록일 경우 null)", example = "1", nullable = true) Integer grade,

        @Schema(description = "시험지 목록") List<ExamSheetInfo> examSheets,
    ...
    public record ExamSheetInfo(
            ...
            @Schema(description = "선택된 단원 수", example = "3") Integer selectedUnitCount) {
