...
public record ExamSubmissionListResponse(
        ...
        @Schema(description = "제출 목록") List<SubmissionInfo> submissions,

        @Schema(description = "총 제출 수", example = "25") int totalCount) {
    ...
    public record SubmissionInfo(
            @Schema(description = "제출 ID", example = "123e4567-e89b-12d3-a456-426614174001") UUID submissionId,
            ...
            @Schema(description = "총점", example = "85", nullable = true) Integer totalScore) {
