...
public record QuestionStatisticsResponse(
        ...
        @Schema(description = "전체 문제 수", example = "30") int totalQuestions,

        @Schema(description = "쉬움 문제 수", example = "10") int easyCount,

        @Schema(description = "보통 문제 수", example = "15") int mediumCount,

        @Schema(description = "어려움 문제 수", example = "5") int hardCount) {
