 ...
 */
@Repository
public interface QuestionResultRepository extends JpaRepository<ExamResultQuestion, UUID> {
     ...
     * @return 정답/오답 결과 페이지
     */
    Page<ExamResultQuestion> findByIsCorrectOrderByCreatedAtDesc(Boolean isCorrect, Pageable pageable);
    ...
    Page<ExamResultQuestion> findByScoreBetween(
    ...
    Page<ExamResultQuestion> findByConfidenceScoreBetween(
     ...
     * @return 해당 답안의 채점 결과
     */
    Optional<ExamResultQuestion> findByStudentAnswerSheetId(UUID studentAnswerSheetId);
