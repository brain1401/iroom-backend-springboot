...
public record ExamDto(
        ...
        @Schema(description = "시험 내용/설명", example = "2학년 중간고사입니다") String content,
    ...
    Integer actualStudentCount,
        ...
        @Schema(description = "QR 코드 URL") String qrCodeUrl,

        @Schema(description = "시험 생성일시") LocalDateTime createdAt,

        @Schema(description = "연결된 시험지 정보") ExamSheetInfo examSheetInfo) {
    /**
    ...
    public static ExamDto from(Exam exam) {
        return new ExamDto(
                ...
                exam.getContent(),
                exam.getMaxStudent(),
                0, // actualStudentCount는 별도 조회 필요
                exam.getQrCodeUrl(),
                exam.getCreatedAt(),
