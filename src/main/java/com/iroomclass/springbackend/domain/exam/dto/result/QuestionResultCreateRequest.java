...
public record QuestionResultCreateRequest(
        ...
        @Schema(description = "만점", example = "5", requiredMode = Schema.RequiredMode.REQUIRED) @NotNull(message = "만점은 필수입니다") @Min(value = 1, message = "만점은 1 이상이어야 합니다") @Max(value = 100, message = "만점은 100 이하여야 합니다") Integer maxScore,

        @Schema(description = "채점 방법", example = "AUTO", requiredMode = Schema.RequiredMode.REQUIRED) @NotNull(message = "채점 방법은 필수입니다") GradingMethod gradingMethod,
