...
public class QuestionService {
    ...
    public QuestionListResponse getQuestionsByUnit(UUID unitId) {
        ...
        return new QuestionListResponse(unitId, unit.getUnitName(), questionInfos, totalQuestions, (int) easyCount,
    ...
    public QuestionListResponse getQuestionsByUnitAndDifficulty(UUID unitId, String difficulty) {
        ...
        return new QuestionListResponse(unitId, unit.getUnitName(), questionInfos, totalQuestions, easyCount,
    ...
    public QuestionStatisticsResponse getQuestionStatisticsByUnit(UUID unitId) {
        ...
        return new QuestionStatisticsResponse(unitId, unit.getUnitName(), totalQuestions, (int) easyCount,
                (int) mediumCount, (int) hardCount);
    }
