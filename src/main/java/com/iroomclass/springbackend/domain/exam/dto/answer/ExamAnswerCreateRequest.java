...
public record ExamAnswerCreateRequest(
        @NotNull(message = "시험 제출 ID는 필수입니다.") @Schema(description = "시험 제출 ID", example = "123e4567-e89b-12d3-a456-426614174000", requiredMode = Schema.RequiredMode.REQUIRED) UUID examSubmissionId,

        @NotNull(message = "문제 ID는 필수입니다.") @Schema(description = "문제 ID", example = "123e4567-e89b-12d3-a456-426614174001", requiredMode = Schema.RequiredMode.REQUIRED) UUID questionId,

        @Schema(description = "답안 이미지 URL (주관식 문제용)", example = "https://example.com/answer-image.jpg") String answerImageUrl,

        @Schema(description = "선택한 답안 번호 (객관식 문제용)", example = "1") Integer selectedChoice) {
