...
public record ExamSubmissionStatusDto(
    ...
    @Schema(description = "최근 제출자 목록 (최대 5명)")
    ...
    public record HourlyStats(
        @Schema(description = "시간 (예: 2024-08-17 14:00:00)")
        String hour,
        
        @Schema(description = "해당 시간 제출 수", example = "15")
        Long submissionCount
    ) {
        /**
         * Repository 결과로부터 DTO 생성
         */
        public static HourlyStats from(com.iroomclass.springbackend.domain.exam.repository.ExamSubmissionRepository.HourlySubmissionStats stats) {
    ...
    public record SubmissionStats(
        @Schema(description = "총 예상 제출자 수 (해당 학년 전체 학생 수)", example = "120")
        Long totalExpectedStudents,
        
        @Schema(description = "실제 제출자 수", example = "95")
        Long actualSubmissions,
        
        @Schema(description = "미제출자 수", example = "25")
        Long notSubmitted,
        
        @Schema(description = "제출률 (%)", example = "79.17")
         ...
         * 제출 통계 생성
         * 
         * @param totalExpected 총 예상 학생 수
         * @param actualSubmissions 실제 제출 수
         * @return 제출 통계
         */
        public static SubmissionStats create(Long totalExpected, Long actualSubmissions) {
            Long notSubmitted = totalExpected - actualSubmissions;
    ...
    public record ExamInfo(
        ...
        ExamSheetSummary examSheetInfo
    ) {
        /**
         * Exam으로부터 기본 정보 생성
         */
