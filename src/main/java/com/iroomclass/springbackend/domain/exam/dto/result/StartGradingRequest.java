...
public record StartGradingRequest(
        @NotNull(message = "시험 제출 ID는 필수입니다") @Schema(description = "시험 제출 ID", example = "123e4567-e89b-12d3-a456-426614174001", requiredMode = Schema.RequiredMode.REQUIRED) UUID submissionId,
