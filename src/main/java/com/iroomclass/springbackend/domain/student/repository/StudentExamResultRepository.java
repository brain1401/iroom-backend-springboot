 ...
 * 
 * <p>
 * 학생 API에서 사용하는 시험 결과 관련 복잡한 조회를 담당합니다.
 * N+1 문제 방지를 위해 EntityGraph와 fetch join을 활용합니다.
 * </p>
 * 
 * @author 이룸클래스
 * @since 2025
...
public interface StudentExamResultRepository extends JpaRepository<ExamResult, UUID> {
     ...
     * 
     * <p>
     * Endpoint 4: 문제 full 정보 조회
     * - 문제 번호로 특정 문제의 상세 정보 조회
     * - Question과 관련된 모든 정보 포함
     * </p>
     * 
     * @param studentId     학생 ID
     * @param examId        시험 ID
    ...
    @Query("""
            ...
            """)
    Optional<com.iroomclass.springbackend.domain.exam.entity.ExamResultQuestion> findQuestionResultByStudentIdAndExamIdAndQuestionOrder(
            @Param("studentId") Long studentId,
            @Param("examId") UUID examId,
     ...
     * 
     * <p>
     * 학생 정보 조회 시 가장 최근 응시한 시험의 학년을 가져오기 위해 사용
     * </p>
     * 
     * @param studentId 학생 ID
     ...
     * 
     * <p>
     * 중복 제거하여 실제 응시한 시험 수만 계산 (재채점은 제외)
     * </p>
     * 
     * @param studentId 학생 ID
     * @return 총 응시 시험 수
     ...
     * 
     * <p>
     * 상세 시험 결과에서 객관식/주관식 문제 수를 계산하기 위해 사용
     * </p>
     * 
     * @param studentId 학생 ID
     * @param examId    시험 ID
     ...
     * 
     * <p>
     * 학생이 응시한 모든 시험의 평균 점수를 계산합니다.
     * 재채점된 경우 최신 버전의 결과만 사용합니다.
     * </p>
     * 
     * @param studentId 학생 ID
     ...
     * 
     * <p>
     * 복잡한 fetch join 대신 EntityGraph를 사용하여
     * 필요한 연관 엔티티들을 한 번에 조회합니다.
     * </p>
     * 
